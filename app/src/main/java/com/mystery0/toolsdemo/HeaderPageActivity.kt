...
class HeaderPageActivity : AppCompatActivity()
{
	...
	override fun onCreate(savedInstanceState: Bundle?)
	{
		...
		list.add(Header("http://img.kaiyanapp.com/8c66311bc96f662edd67bbcb1769684b.jpeg?imageMogr2/quality/60/format/jpg", "title1", "subtitle1"))
		list.add(Header("http://img.kaiyanapp.com/83d3dddeeefa3f6549030938ab24533c.jpeg?imageMogr2/quality/60/format/jpg", "title1", "subtitle1"))
		list.add(Header("http://img.kaiyanapp.com/4cd80e67eb0e293b84d45cf3151536b9.jpeg?imageMogr2/quality/60/format/jpg", "title1", "subtitle1"))
		list.add(Header("http://img.kaiyanapp.com/4cd80e67eb0e293b84d45cf3151536b9.jpeg?imageMogr2/quality/60/format/jpg", "title1", "subtitle1"))
		list.add(Header("http://img.kaiyanapp.com/4cd80e67eb0e293b84d45cf3151536b9.jpeg?imageMogr2/quality/60/format/jpg", "title1", "subtitle1"))
		list.add(Header("http://img.kaiyanapp.com/4cd80e67eb0e293b84d45cf3151536b9.jpeg?imageMogr2/quality/60/format/jpg", "title1", "subtitle1"))
		list.add(Header("http://img.kaiyanapp.com/83d3dddeeefa3f6549030938ab24533c.jpeg?imageMogr2/quality/60/format/jpg", "title1", "subtitle1"))
