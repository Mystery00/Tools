...
internal class IPictureChooserAdapter(private var pathList: ArrayList<String>, private var add_img: Int,
									  var context: Context) : RecyclerView.Adapter<IPictureChooserAdapter.ViewHolder>() {
	var listener: IPictureChooserListener? = null

	fun setIPictureChooserListener(pictureListener: () -> Unit) {
		listener = object : IPictureChooserListener {
